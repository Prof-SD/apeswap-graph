...
export class abi__tokenTableResult {
  value0: boolean;
  value1: BigInt;
...
export class abi extends ethereum.SmartContract {
  ...
  tokenTable(param0: Address): abi__tokenTableResult {
    ...
    return new abi__tokenTableResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }

  try_tokenTable(param0: Address): ethereum.CallResult<abi__tokenTableResult> {
    ...
    return ethereum.CallResult.fromValue(
      new abi__tokenTableResult(value[0].toBoolean(), value[1].toBigInt())
    );
  }
