...
export class abi__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class abi extends ethereum.SmartContract {
  ...
  checkpoints(param0: Address, param1: BigInt): abi__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new abi__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<abi__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new abi__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
